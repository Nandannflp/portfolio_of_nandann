  ...
  return (
    ...
    >
      <div className="flex flex-col items-center space-y-2">
        <div className="h-20 md:h-32 w-1 bg-emerald-500 rounded-full" />
        <div className="rotate-0 [writing-mode:vertical-lr] text-3xl md:text-5xl font-black tracking-widest uppercase drop-shadow-2xl text-emerald-500 pb-2">
          Nandann Shetye
        </div>
      </div>
    </motion.div>
