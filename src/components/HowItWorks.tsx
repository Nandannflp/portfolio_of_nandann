...
export default function HowItWorks() {
  ...
  return (
    <section id="process" className="relative z-20 py-32 px-6 md:px-12 border-t border-white/5">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          {steps.map((step, idx) => (
            <div key={idx} className="relative z-10 glass-card p-10 bg-white/[0.04] border-white/10 group hover:-translate-y-2 hover:border-emerald-500/40 hover:bg-white/[0.07] transition-all duration-300 shadow-[0_0_20px_rgba(16,185,129,0.02)] hover:shadow-[0_0_40px_rgba(16,185,129,0.1)]">
