...
export const AntigravityIcon = ({ className = "" }: { className?: string }) => (
  <svg className={`group ${className}`} width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path 
      className="fill-white group-hover:opacity-0 transition-opacity duration-300"
